...
class TamperingRuleEngine:
    ...
    def _load_builtin_rules(self) -> None:
        ...
        builtin = [
            ...
            # Based on section map, handle map, and drawing variables analysis
            # =================================================================
            TamperingRule(
                rule_id="TAMPER-036",
    ...
    # =================================================================
    # DEEP DWG PARSING RULE IMPLEMENTATIONS (TAMPER-036 to TAMPER-040)
    # =================================================================
    ...
    def _check_handle_gap_ratio(
        ...
        gap_ratio = total_missing / (total_handles + total_missing) if (total_handles + total_missing) > 0 else 0
